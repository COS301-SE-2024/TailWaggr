...
class LostAndFoundTablet extends StatefulWidget {
  ...
  @override
  State<LostAndFoundTablet> createState() => _LostAndFoundTabletState();
}

class _LostAndFoundTabletState extends State<LostAndFoundTablet> {
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    height: MediaQuery.of(context).size.height - 307.0,
...
class _ListOfPetsState extends State<ListOfPets> {
  ...
  ScrollController petScrollController = ScrollController();
  ScrollController sightingScrollController = ScrollController();
  ...
  Widget build(BuildContext context) {
    if (petSelected) {
        ...
        child: Column(
          ...
          children: [
            ...
            Scrollbar(
              ...
              controller: sightingScrollController,
      ...
      return Container(
        ...
        child: Scrollbar(
          thumbVisibility: true,
          controller: petScrollController,
          child: SingleChildScrollView(
            scrollDirection: Axis.horizontal,
            controller: petScrollController,
            child: Row(
